...
const api = {
    get: async <T, TQuery = Record<string, unknown>>(url: string, { headers, params, query }: RequestParams<never, TQuery> = {}): Promise<ApiResponse<T>> => {
        try {
    ...
    post: async <T, TBody = unknown, TQuery = Record<string, unknown>>(url: string, { headers, body, query }: RequestParams<TBody, TQuery> = {}): Promise<ApiResponse<T>> => {
        try {
    ...
    put: async <T, TBody = unknown, TQuery = Record<string, unknown>>(url: string, { headers, body, query }: RequestParams<TBody, TQuery> = {}): Promise<ApiResponse<T>> => {
        try {
    ...
    delete: async <T, TBody = unknown, TQuery = Record<string, unknown>>(url: string, { headers, body, query }: RequestParams<TBody, TQuery> = {}): Promise<ApiResponse<T>> => {
        try {
    ...
    putRaw: async <T, TBody = unknown, TQuery = Record<string, unknown>>(url: string, { headers, body, query }: RequestParams<TBody, TQuery> = {}): Promise<T> => {
        try {
    ...
    deleteRaw: async <T, TBody = unknown, TQuery = Record<string, unknown>>(url: string, { headers, body, query }: RequestParams<TBody, TQuery> = {}): Promise<T> => {
        try {
