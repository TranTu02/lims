...
export type OrderStatus = "Completed" | "Processing" | "Pending" | "Cancelled" | (string & {});

export type PaymentStatus = "Paid" | "Unpaid" | "Partially" | "Debt" | (string & {});

export type OrderTransactionMethod = "BankTransfer" | "Cash" | "Card" | (string & {});
...
export type OrderListItem = Pick<OrderDetail, "orderId" | "quoteId" | "clientId" | "totalAmount" | "orderStatus" | "paymentStatus" | "createdAt"> & {
    [key: string]: unknown;
};
