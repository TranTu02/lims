...
export function Sidebar({ activeTab, onTabChange, sidebarOpen = true }: SidebarProps) {
    ...
    useEffect(() => {
        const parentGroup = navigation.find((item): item is Extract<NavItem, { type: "group" }> => item.type === "group" && item.subItems.some((sub) => sub.id === activeTab));
            ...
            {!sidebarCollapsed ? (
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className="text-left min-w-0">
                                                                ...
                                                                <div className="text-xs text-muted-foreground mt-0.5 truncate">{t(subItem.descriptionKey)}</div>
                                                            </div>
                                                        </button>
                                                    );
                                                })}
                            ...
                            <div className="grid grid-cols-3 gap-1.5">
                                <button
                                    ...
                                    className={`px-1.5 py-1 text-xs rounded border transition-colors flex flex-col items-center gap-0.5 ${
                                        theme === "light" ? "bg-primary text-primary-foreground border-primary" : "bg-card text-foreground border-border hover:bg-muted"
                                    }`}
                                    type="button"
                                >
                                    <Sun className="h-3 w-3" />
                                ...
                                <button
                                    ...
                                    className={`px-1.5 py-1 text-xs rounded border transition-colors flex flex-col items-center gap-0.5 ${
                                        theme === "dark" ? "bg-primary text-primary-foreground border-primary" : "bg-card text-foreground border-border hover:bg-muted"
                                    }`}
                                    type="button"
                                >
                                ...
                                <button
                                    ...
                                    className={`px-1.5 py-1 text-xs rounded border transition-colors flex flex-col items-center gap-0.5 ${
                                        theme === "system" ? "bg-primary text-primary-foreground border-primary" : "bg-card text-foreground border-border hover:bg-muted"
                                    }`}
                                    type="button"
                                >
                ...
                <>
                    ...
                    <div className="p-2 border-b border-border flex flex-col items-center gap-2 h-16 justify-center">
                        ...
                        <button onClick={() => setSidebarCollapsed(false)} className="p-1.5 hover:bg-muted rounded transition-colors" title={t("nav.sidebar.expand")} type="button">
                            ...
                            if (item.type === "group") {
                                ...
                                return (
                                    <div key={item.id} className="space-y-1">
                                        <button
                                            onClick={() => setExpandedGroup(isExpanded ? null : item.id)}
                                            className={`w-full p-2 rounded-lg transition-colors flex items-center justify-center ${isAnySubActive ? "bg-primary/10" : "hover:bg-muted"}`}
                    ...
                    <div className="p-2 border-t border-border flex flex-col items-center gap-1 shrink-0">
                        <button className="p-1.5 hover:bg-muted rounded transition-colors" title={t("nav.sidebar.language")} onClick={() => setLanguage(language === "en" ? "vi" : "en")} type="button">
