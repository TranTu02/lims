...
export function IncomingRequestDetailModal({ requestId, onClose }: Props) {
    ...
    return (
        <>
            <div className="fixed inset-0 bg-foreground/50 z-50 flex items-center justify-center p-4 transition-opacity backdrop-blur-sm" onClick={onClose}>
                <div
                    className="bg-background rounded-xl shadow-2xl w-[80vw] min-w-[800px] h-[90vh] max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200 border border-border"
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 rounded-xl bg-muted/20 border border-border">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1.5 font-medium text-foreground">
                                            {String((request as any).salePerson?.identityName || request.salePersonId || request.salePerson || "-")}
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="border border-border rounded-xl bg-card overflow-hidden">
                                            ...
                                            <div className="p-4">
                                                {(request.samples?.length ?? 0) === 0 ? (
                                                    <div className="text-center py-6 text-sm text-muted-foreground italic bg-muted/20 border border-dashed rounded-lg">
                                                        Không có mẫu nào trong yêu cầu.
                                                    </div>
                                                ) : (
