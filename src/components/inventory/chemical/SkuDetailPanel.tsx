        ...
        <>
            <div className="w-96 lg:w-[450px] shrink-0 bg-background rounded-lg border border-border overflow-y-auto max-h-[calc(100vh-140px)] sticky top-[72px]">
                <div className="sticky top-0 bg-background border-b border-border px-4 py-3 flex items-start justify-between z-10">
                    <div>
                        <h2 className="text-base font-semibold text-foreground">Chi tiết Hóa chất</h2>
                    ...
                    <div className="p-4 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="col-span-2">
                                <div className="text-[11px] text-muted-foreground uppercase tracking-wider font-semibold">Tên hóa chất</div>
                                <div className="text-base text-foreground font-semibold mt-1">{displaySku.chemicalName || "-"}</div>
                            </div>

                            <div>
                                <div className="text-[11px] text-muted-foreground uppercase tracking-wider font-semibold">Số CAS</div>
                                <div className="text-sm font-medium mt-1">{displaySku.chemicalCASNumber || "-"}</div>
                            </div>

                            <div>
                                <div className="text-[11px] text-muted-foreground uppercase tracking-wider font-semibold">Phân loại nguy hiểm</div>
                            ...
                            <div>
                                <div className="text-[11px] text-muted-foreground uppercase tracking-wider font-semibold">Tổng tồn vật lý</div>
                            ...
                            <div>
                                <div className="text-[11px] text-muted-foreground uppercase tracking-wider font-semibold">Mức tối thiểu (Reorder)</div>
                                ...
                                <div className="max-h-[300px] overflow-y-auto border border-border rounded-md">
                                    <table className="w-full text-xs">
                                        <thead className="bg-muted/50 sticky top-0">
                                            <tr>
                                                <th className="text-left px-2 py-1.5 font-semibold text-muted-foreground">Mã chai</th>
                                                <th className="text-left px-2 py-1.5 font-semibold text-muted-foreground">Số Lô</th>
                                                <th className="text-right px-2 py-1.5 font-semibold text-muted-foreground">Tồn</th>
                                                <th className="text-center px-2 py-1.5 font-semibold text-muted-foreground">Trạng thái</th>
                                            </tr>
                                        </thead>
                                    ...
                                    {suppliers.map((sup: any) => (
                                        <div key={sup.chemicalSku_chemicalSupplierId} className="p-3 border border-border rounded-md bg-muted/20 text-sm">
                                            ...
                                            <div className="flex justify-between text-muted-foreground text-xs mt-1">
                                                <span>
                                                    Mã Catalog: <strong className="text-foreground">{sup.catalogNumber}</strong>
                                                </span>
                                                <span>
                                                    Hãng: <strong className="text-foreground">{sup.brandManufacturer}</strong>
                                                </span>
                                            </div>
                                            <div className="flex justify-between text-muted-foreground text-xs mt-1">
                                                <span>
                                                    Q/C đóng gói: <strong className="text-foreground">{sup.packagingSize}</strong>
                                                </span>
                                                <span>
                                                    Lead (ngày): <strong className="text-foreground">{sup.leadTimeDays}</strong>
                                                </span>
                                            </div>
                                        </div>
                                    ))}
