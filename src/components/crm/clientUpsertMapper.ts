import type { ClientContact, ClientInvoiceInfo, ClientsCreateBody, ClientsUpdateBody } from "@/types/crm/client";
...
export function normalizeContacts(v: ClientContact[] | null | undefined): ClientUpsertFormState["clientContacts"] {
...
export function normalizeInvoice(v: ClientInvoiceInfo | null | undefined): ClientUpsertFormState["invoiceInfo"] {
    return {
...
export function toClientCreateBody(values: ClientUpsertFormState): ClientsCreateBody {
    return {
        ...
        assignedSaleId: toNullIfEmpty(values.assignedSaleId),
        clientScope: toNullIfEmpty(values.clientScope),
        ...
        invoiceInfo:
            toNullIfEmpty(values.invoiceInfo.taxAddress) || toNullIfEmpty(values.invoiceInfo.taxCode) || toNullIfEmpty(values.invoiceInfo.taxName) || toNullIfEmpty(values.invoiceInfo.taxEmail)
                ? {
