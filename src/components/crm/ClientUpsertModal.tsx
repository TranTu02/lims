...
import { emptyContact, joinArr, normalizeContacts, normalizeInvoice, type ClientUpsertFormState as FormState } from "@/components/crm/clientUpsertMapper";
...
function toAvailableRows(from: Pick<FormState, "availableByIds" | "availableByName">): AvailableRow[] {
...
export function ClientUpsertModal({ open, mode, initial, onClose, onSubmit }: Props) {
    ...
    const initialForm = useMemo<FormState>(() => {
        ...
        return {
            ...
            assignedSaleId: toStr(base?.assignedSaleId ?? ""),
            clientScope: toStr(base?.clientScope ?? ""),
    ...
    const [availableRows, setAvailableRows] = useState<AvailableRow[]>(() => toAvailableRows(initialForm));
    ...
    const title = mode === "create" ? t("crm.clients.create.title") : t("crm.clients.update.title");
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="space-y-6">
                                <div className="rounded-lg border border-border p-4 space-y-4">
                                    <div className="text-sm font-medium text-foreground">{t("crm.clients.sections.base.title")}</div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input value={form.legalId} onChange={(e) => setForm((s) => ({ ...s, legalId: e.target.value }))} placeholder={t("crm.clients.placeholders.legalId")} />
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                <SelectTrigger>
                                                    <SelectValue placeholder={t("crm.clients.placeholders.saleScope")} />
                                                </SelectTrigger>

                                                <SelectContent>
                                                    <SelectItem value="private">{t("crm.clients.saleScope.private")}</SelectItem>
                                                    <SelectItem value="public">{t("crm.clients.saleScope.public")}</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            <div className="text-xs text-muted-foreground">{t("crm.clients.columns.assignedSale", { defaultValue: "Sale phụ trách" })}</div>
                                            <Select value={form.assignedSaleId} onValueChange={(v) => setForm((s) => ({ ...s, assignedSaleId: v }))}>
                                                <SelectTrigger>
                                                    <SelectValue placeholder={t("crm.clients.placeholders.assignedSale", { defaultValue: "Chọn nhân viên sale" })} />
                                                </SelectTrigger>
                                                <SelectContent>
                                                    {staff.map((s) => (
                                                        <SelectItem key={s.identityId} value={s.identityId}>
                                                            {s.identityName} ({s.alias || s.email})
                                                        </SelectItem>
                                                    ))}
                                                </SelectContent>
                                            </Select>
                                        ...
                                        <div className="space-y-2">
                                            <div className="text-xs text-muted-foreground">{t("crm.clients.columns.scope", { defaultValue: "Phạm vi (Scope)" })}</div>
                                            <Input
                                                value={form.clientScope}
                                                onChange={(e) => setForm((s) => ({ ...s, clientScope: e.target.value }))}
                                                placeholder={t("crm.clients.placeholders.scope", { defaultValue: "VD: Thực phẩm, Quan trắc..." })}
                                            />
                                        </div>
                                ...
                                {mode === "create" ? (
                                    <div className="rounded-lg border border-border p-4 space-y-4">
                                        <div className="flex items-center justify-between gap-2">
                                            <div className="text-sm font-medium text-foreground">{t("crm.clients.sections.available.title")}</div>
                                        ...
                                        {availableRows.length === 0 ? (
                                            <div className="text-sm text-muted-foreground">{t("crm.clients.sections.available.empty")}</div>
                                        ) : (
                                                    ...
                                                    <div key={idx} className="rounded-lg border border-border p-3 space-y-3">
                                                        <div className="flex items-center justify-between gap-2">
                                                            ...
                                                            <Button
                                                                ...
                                                                size="sm"
                                                                onClick={() => {
                                                                    const next = availableRows.filter((_, i) => i !== idx);
                                                                    setAvailableRows(next);
                                                                    setForm((s) => ({
                                                                        ...s,
                                                                        ...rowsToStrings(next),
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div className="space-y-2">
                                                                <div className="text-xs text-muted-foreground">{t("crm.clients.sections.available.byIds")}</div>
                                                                <Input
                                                                    value={row.id}
                                                                    onChange={(e) => {
                                                                    ...
                                                                    placeholder={t("crm.clients.sections.available.byIdsPlaceholder")}
                                                                />
                                                            </div>

                                                            <div className="space-y-2">
                                                                <div className="text-xs text-muted-foreground">{t("crm.clients.sections.available.byName")}</div>
                                                                <Input
                                                                    value={row.name}
                                                                    onChange={(e) => {
                                                                        const next = [...availableRows];
                                                                    ...
                                                                    placeholder={t("crm.clients.sections.available.byNamePlaceholder")}
                                                                />
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div className="space-y-6">
                                {mode === "create" ? (
                                    <div className="rounded-lg border border-border p-4 space-y-4">
                                        <div className="text-sm font-medium text-foreground">{t("crm.clients.sections.invoice.title")}</div>

                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-2">
                                                <div className="text-xs text-muted-foreground">{t("crm.clients.sections.invoice.taxName")}</div>
                                                <Input
                                            ...
                                            <div className="space-y-2">
                                                <div className="text-xs text-muted-foreground">{t("crm.clients.sections.invoice.taxCode")}</div>
                                                <Input
                                            ...
                                            <div className="space-y-2">
                                                <div className="text-xs text-muted-foreground">{t("crm.clients.sections.invoice.taxEmail")}</div>
                                                <Input
                                            ...
                                            <div className="space-y-2">
                                                <div className="text-xs text-muted-foreground">{t("crm.clients.sections.invoice.taxAddress")}</div>
                                                <Input
                                ...
                                <div className="rounded-lg border border-border p-4 space-y-4">
                                    <div className="flex items-center justify-between gap-2">
                                        <div className="text-sm font-medium text-foreground">{t("crm.clients.sections.contacts.title")}</div>
                                        ...
                                        <Button
                                            ...
                                            onClick={() =>
                                                setForm((s) => ({
                                                    ...s,
                                                    clientContacts: [...s.clientContacts, { ...emptyContact }],
                                                }))
                                            }
                                            className="flex items-center gap-2"
                                        >
                                    ...
                                    {form.clientContacts.length === 0 ? (
                                        <div className="text-sm text-muted-foreground">{t("crm.clients.sections.contacts.empty")}</div>
                                    ) : (
                                        <div className="space-y-4">
                                            {form.clientContacts.map((c, idx) => (
                                                <div key={idx} className="rounded-lg border border-border p-3 space-y-3">
                                                    <div className="flex items-center justify-between gap-2">
                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={() =>
                                                                setForm((s) => ({
                                                                    ...s,
                                                                    clientContacts: s.clientContacts.filter((_, i) => i !== idx),
                                                                }))
                                                            }
                                                            className="flex items-center gap-2"
                                                        >
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        <div className="space-y-2">
                                                            <div className="text-xs text-muted-foreground">{t("crm.clients.sections.contacts.fields.contactId")}</div>
                                                            <Input
                                                                value={c.contactId}
                                                                onChange={(e) =>
                                                                    setForm((s) => {
                                                                ...
                                                                placeholder={t("crm.clients.sections.contacts.fields.contactIdPlaceholder")}
                                                            />
                                                        </div>

                                                        <div className="space-y-2">
                                                            <div className="text-xs text-muted-foreground">{t("crm.clients.sections.contacts.fields.contactName")}</div>
                                                            <Input
                                                                value={c.contactName}
                                                                onChange={(e) =>
                                                                    setForm((s) => {
                                                        ...
                                                        <div className="space-y-2">
                                                            <div className="text-xs text-muted-foreground">{t("crm.clients.sections.contacts.fields.contactPhone")}</div>
                                                            <Input
                                                        ...
                                                        <div className="space-y-2">
                                                            <div className="text-xs text-muted-foreground">{t("crm.clients.sections.contacts.fields.contactEmail")}</div>
                                                            <Input
                                                        ...
                                                        <div className="space-y-2">
                                                            <div className="text-xs text-muted-foreground">{t("crm.clients.sections.contacts.fields.contactPosition")}</div>
                                                            <Input
                                                        ...
                                                        <div className="space-y-2">
                                                            <div className="text-xs text-muted-foreground">{t("crm.clients.sections.contacts.fields.contactAddress")}</div>
                                                            <Input
