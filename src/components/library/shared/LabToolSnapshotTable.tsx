...
export function LabToolSnapshotTable({ items, onChange, disabled }: Props) {
    const { t } = useTranslation();

    const addItem = () => {
        onChange([...items, { labToolId: "", labToolName: "", labToolType: "" }]);
    };
                            ...
                            <tr key={idx} className="hover:bg-muted/30">
                                <td className="px-3 py-1.5">
                                    <Input
                                        ...
                                        onChange={(e) => updateField(idx, "labToolId", e.target.value)}
                                        placeholder="TOOL_..."
                                        disabled={disabled}
                                    />
                                </td>
                                <td className="px-3 py-1.5">
                                    <Input
                                        ...
                                        onChange={(e) => updateField(idx, "labToolName", e.target.value)}
                                ...
                                <td className="px-3 py-1.5">
                                    <Input
                                        ...
                                        onChange={(e) => updateField(idx, "labToolType", e.target.value)}
                                        placeholder="Loại..."
                                        disabled={disabled}
                                    />
                                </td>
