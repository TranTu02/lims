...
| `methodLOD` | `text` | | **(Snapshot)** LOD tại thời điểm thử. |

| `methodLOQ` | `text` | | **(Snapshot)** LOQ tại thời điểm thử. |
...
| `documentType` | `text` | | **[MỚI]** Phân loại: `RECEIPT`,`ORDER`,`QUOTE`, `REQUEST_FORM`,`INVOICE`,`SOP`,`CHEMICAL_COA`, `LAB_REPORT`, `HANDOVER`,... |
...
| `lotNumber`                     | `text`    |        | **[MỚI]** Số lô của chai/lọ tại thời điểm kiểm kê.                                                          |
